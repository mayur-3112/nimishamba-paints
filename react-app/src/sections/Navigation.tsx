    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          >
            ...
            <div className="flex flex-col leading-none text-left">
              ...
              <span className="font-sans text-[9px] font-bold text-neutral-mid tracking-wider uppercase">SURFACE SOLUTIONS</span>
            </div>
          </a>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-neutral-light flex lg:hidden h-16 shadow-[0_-4px_20px_rgba(0,0,0,0.06)]">
        ...
        >
          ...
          <span className="font-display text-[10px] font-bold uppercase tracking-wider">Get Consultation</span>
        </button>
      </div>

      {/* Desktop floating WhatsApp */}
      <a
        href="https://wa.me/919448084351?text=Hi%2C%20I%27d%20like%20to%20discuss%20a%20project%20consultation."
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Chat with Nimishamba on WhatsApp"
